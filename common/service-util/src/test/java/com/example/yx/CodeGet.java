...
public class CodeGet {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\JavaLearningProjection\\Microservice-Projection\\fyc-yx-parent\\service\\service-order"+"/src/main/java");
        ...
        dsc.setPassword("fyc123456");
        dsc.setDbType(DbType.MYSQL);
        mpg.setDataSource(dsc);

        // 4、包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.example.yx");
